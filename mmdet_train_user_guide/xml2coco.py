...
def convert(xml_list, json_file):
    ...
    for index, line in enumerate(xml_list):
        ...
        for obj in get(root, 'object'):
            ...
            if category not in categories:
                ...
                print("[warning] category '{}' not in 'pre_define_categories'({}), create new id: \
                    {} automatically".format(category, pre_define_categories, new_id))
    ...
    print("find {} categories: {} -->>> your pre_define_categories {}: \
        {}".format(len(all_categories), all_categories.keys(), len(pre_define_categories), \
